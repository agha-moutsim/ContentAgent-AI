    ...
    <div className="glass p-10 rounded-[2.5rem] shadow-glass border-white/10 animate-fade-in relative overflow-hidden group">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        ...
        <p className="mt-2 text-center text-[10px] text-gray-500 font-bold uppercase tracking-[0.2em]">
          Secure entry into Content AI Engine
        </p>
      </div>
      ...
      <form className="mt-10 space-y-6 relative z-10" onSubmit={handleSubmit}>
        ...
        <div className="space-y-1">
          ...
          <div className="mt-1">
            <input
              ...
              className="appearance-none block w-full px-4 py-3 bg-white/5 border border-white/10 rounded-2xl shadow-inner text-white placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500/50 transition-all font-medium text-sm"
            />
          </div>
        </div>
        ...
        <div>
          <button
            type="submit"
            disabled={loading}
            className="w-full flex justify-center items-center py-4 px-4 border border-indigo-500/30 rounded-2xl shadow-glow text-xs font-black text-white bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 transition-all duration-300 uppercase tracking-[0.2em] transform active:scale-95 disabled:opacity-50 group/btn"
          >
            {loading ? (
              ...
              <>
                Ignite Session
                <svg className="ml-2 h-4 w-4 transition-transform group-hover/btn:translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M13 7l5 5m0 0l-5 5m5-5H6" /></svg>
              </>
            )}
          </button>
        </div>
